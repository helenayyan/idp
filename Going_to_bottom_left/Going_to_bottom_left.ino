...
double find_distance_encoder(int encoderPin){
...
double find_velocity_encoder(int encoderPin){

    double distance1 = find_distance_encoder(encoderPin);
    int time1 = millis();
    delay(100);
    double distance2 = find_distance_encoder(encoderPin);
    int time2 = millis();
